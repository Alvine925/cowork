      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="hidden lg:block lg:w-1/3 pt-4">
            <span className="text-[180px] font-bold text-gray-50 leading-none select-none tracking-tighter">
              10
            </span>
          </div>
          ...
          <div className="w-full lg:w-2/3 flex flex-col">
            {SERVICES.map((service, i) => (
              <Link href="/services" key={i} className="group block border-b border-gray-100 pb-5 mb-5 hover:border-gray-300 transition-colors">
                <div className="flex flex-col md:flex-row md:items-baseline gap-2 md:gap-6">
                  <span className="text-gray-200 text-xs tracking-widest font-mono">
                    {(i + 1).toString().padStart(2, '0')}
                  </span>
                  <div className="flex-1 flex flex-col md:flex-row md:items-center justify-between gap-2">
                    <h3 className="text-gray-900 text-xl font-[family-name:var(--font-heading)] font-medium group-hover:text-gold transition-colors">
                      {service.name}
                    </h3>
