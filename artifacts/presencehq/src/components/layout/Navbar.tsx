...
export function Navbar() {
  ...
  const logoClasses = cn(
    'text-lg md:text-xl font-bold tracking-[0.2em] uppercase font-heading',
            ...
            <div className="flex flex-col items-center gap-8 w-full max-w-sm">
              {[
                ...
                <Link
                  key={item.href}
                  href={item.href}
                  className="text-2xl font-light text-navy tracking-widest uppercase hover:text-gold transition-colors font-heading"
                >
                  {item.label}
                </Link>
              ))}
              <Link
                href="/contact"
                className="mt-8 border border-navy text-navy hover:bg-navy hover:text-white px-8 py-3 text-sm tracking-widest uppercase transition-colors"
              >
                Get Started
              </Link>
            </div>
