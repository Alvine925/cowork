  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Please read these terms carefully before using any PresenceHQ service."
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 md:px-12 max-w-3xl prose prose-gray prose-headings:font-heading prose-headings:text-navy">
          ...
          <p>
            The specific services included in your subscription are detailed in your chosen plan at the time of signup. PresenceHQ reserves the right to modify service offerings with 30 days written notice to active clients.
          </p>

          <h2>3. Account Registration and KYC Compliance</h2>
          <p>
            To activate any PresenceHQ service, you must complete our onboarding process, which includes providing the following documents in accordance with Kenyan anti-money laundering and Know Your Customer (KYC) regulations:
          </p>
          <ul>
          ...
          <p>
            All KYC documents must be submitted within 14 days of signup. Services will not be activated until documentation has been reviewed and approved. If documents are not provided within 30 days, PresenceHQ reserves the right to cancel the subscription and withhold any setup fees already paid.
          </p>
          <p>
          ...
          <p>You may use PresenceHQ services for any lawful business purpose. You agree not to use our address or services in connection with:</p>
          <ul>
            ...
            <li>Businesses that are required by law to maintain a physical staffed office (e.g. certain financial institutions) where a virtual office would not satisfy regulatory requirements, without disclosing this to PresenceHQ in writing.</li>
            ...
            <li>Harassment, defamation, or abuse of PresenceHQ staff or other clients.</li>
          </ul>
          <p>
            PresenceHQ may terminate your account immediately and without refund if we determine, in our sole discretion, that your use of our services violates any of the above prohibitions or poses a legal or reputational risk to PresenceHQ or our staff.
          </p>

          <h2>5. Subscription Plans and Payment Terms</h2>
          <p>
            PresenceHQ services are offered on a monthly or annual subscription basis. Prices are listed in Kenyan Shillings (KES) inclusive of applicable taxes unless otherwise stated.
          </p>
          <ul>
            <li><strong>Monthly subscriptions</strong> are billed in advance at the start of each billing cycle. Your first payment is due immediately upon signup.</li>
            <li><strong>Annual subscriptions</strong> are billed in full at the start of the annual term and receive a discount equivalent to two months of the applicable monthly price.</li>
          ...
          <p>
            Accepted payment methods include M-Pesa, bank transfer, Visa, and Mastercard. PresenceHQ does not accept cash payments. Invoices are sent electronically to the email address on file.
          </p>
          <p>
            If a payment is not received by the due date, PresenceHQ will send a reminder. If payment remains outstanding after a 7-day grace period, services (including mail handling and phone answering) will be suspended. If payment is not received within 30 days of the due date, the account may be terminated and any remaining mail or parcels at our premises will be held for a further 14 days before being returned to sender.
          </p>
          <p>
            PresenceHQ reserves the right to adjust subscription prices with 60 days written notice to existing clients. Price changes will apply at the start of the next billing cycle following the notice period.
          </p>

          <h2>6. Cancellation and Refund Policy</h2>
          <p>
            You may cancel your PresenceHQ subscription at any time by providing written notice to hello@presencehq.com or through your account dashboard.
          </p>
          <ul>
          ...
          <p>
            PresenceHQ may cancel your subscription at any time for a material breach of these terms. In the event of termination by PresenceHQ without cause, a pro-rated refund will be issued for the unused portion of your subscription.
          </p>

          <h2>7. Mail and Parcel Handling</h2>
          <p>
            PresenceHQ will accept mail and parcels delivered to your registered address by any carrier. We will notify you via email or SMS within one business day of receipt. The following conditions apply:
          </p>
          <ul>
            ...
            <li>PresenceHQ is not responsible for the contents of mail or parcels and cannot guarantee against loss or damage caused by the carrier prior to delivery to our premises.</li>
          ...
          <ul>
            ...
            <li>Meeting rooms may not be used for events open to the general public without prior written approval from PresenceHQ management.</li>
            <li>Noise levels must be kept at a reasonable level to avoid disturbing other clients.</li>
          </ul>

          <h2>9. Intellectual Property</h2>
          <p>
            All content on the PresenceHQ website, including text, graphics, logos, icons, and software, is the property of PresenceHQ Limited and is protected by Kenyan and international intellectual property laws. You may not reproduce, distribute, or create derivative works from any PresenceHQ content without our prior written consent.
          </p>
          <p>
            PresenceHQ grants you a limited, non-exclusive, non-transferable licence to use our services and access our client portal for the duration of your active subscription.
          </p>

          <h2>10. Limitation of Liability</h2>
          <p>
            To the maximum extent permitted by applicable law, PresenceHQ and its directors, employees, and agents shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of or inability to use our services, including but not limited to loss of profits, loss of data, or loss of business opportunity.
          </p>
          <p>
            Our total aggregate liability to you for any claim arising from or related to these terms or our services shall not exceed the total amount you paid to PresenceHQ in the three calendar months immediately preceding the event giving rise to the claim.
          </p>

          <h2>11. Indemnification</h2>
          <p>
            You agree to indemnify, defend, and hold harmless PresenceHQ, its officers, directors, employees, and agents from and against any claims, damages, losses, costs, and expenses (including reasonable legal fees) arising from your use of our services, your violation of these terms, or your violation of any third-party rights.
          </p>

          <h2>12. Changes to These Terms</h2>
          <p>
            PresenceHQ may update these Terms of Service from time to time. We will notify you of material changes by email at least 30 days before the changes take effect. Your continued use of our services after the effective date of the updated terms constitutes acceptance of the new terms. If you do not agree to the updated terms, you may cancel your subscription before the effective date.
          </p>

          <h2>13. Governing Law and Dispute Resolution</h2>
          <p>
            These Terms of Service are governed by and construed in accordance with the laws of the Republic of Kenya. You agree to submit to the exclusive jurisdiction of the courts of Nairobi, Kenya for any dispute arising from these terms or your use of PresenceHQ services.
          </p>
          <p>
          ...
          <ul>
            <li><strong>Email:</strong> legal@presencehq.com</li>
            <li><strong>Phone:</strong> +254 700 000 000</li>
            <li><strong>Address:</strong> PresenceHQ Limited, Westlands Business Park, Waiyaki Way, Nairobi, Kenya</li>
          </ul>
        </div>
      </section>
    </>
