  ...
  return (
    <GenericServicePage
      config={{
        ...
        description:
          'Expanding into a new market is expensive and risky. With PresenceHQ, you can test a new city with a local business address, phone number, and reception service before committing to a physical lease. Our multi-city packages make expansion affordable for any sized business.',
        features: [
