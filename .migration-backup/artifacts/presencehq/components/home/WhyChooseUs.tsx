...
export function WhyChooseUs() {
  return (
    <section className="flex flex-col lg:flex-row min-h-screen bg-[#F6F8FA]">
      ...
      <div className="w-full lg:w-1/2 relative h-[50vh] lg:h-auto min-h-[400px]">
        <Image
          ...
          alt="Professional workspace details"
          fill
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-12 lg:p-24">
        ...
        <motion.h2 
          ...
          className="text-3xl md:text-4xl font-light font-[family-name:var(--font-heading)] text-gray-900 mb-12 leading-tight max-w-lg"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8">
          ...
          {/* Final bottom borders if needed for alignment */}
